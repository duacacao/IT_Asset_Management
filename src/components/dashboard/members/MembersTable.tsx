...
export const MembersTable = memo(function MembersTable({
    ...
    const columns = useMemo(
        () => createMemberColumns({ onEditRole, onRemove, onResetPassword, currentUserId }),
        [onEditRole, onRemove, onResetPassword, currentUserId]
    )
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        >
                            <SelectTrigger className="h-8 w-[70px] cursor-pointer rounded-xl border-border/50 shadow-sm">
                                <SelectValue />
                            </SelectTrigger>
