        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-1 flex-col gap-3 md:flex-row md:items-center">
                ...
                <div className="flex gap-2">
                    {/* Status Filter */}
                    <Select value={statusFilter} onValueChange={(value) => onStatusFilterChange(value as DeviceStatus | 'all')}>
                    ...
                    {/* Device Type Filter */}
                    <Select value={typeFilter} onValueChange={(value) => onTypeFilterChange(value as DeviceType | 'all')}>
                        <SelectTrigger className="w-full rounded-xl border-border/50 bg-white shadow-sm dark:bg-card md:w-[180px]">
            ...
            <div className="flex items-center gap-2">
                {/* Bulk delete — chỉ hiển thị khi có selection */}
                {selectedCount > 0 && (
                    <Button
                        variant="destructive"
                        size="icon"
