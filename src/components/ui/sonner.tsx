  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        style: {
          '--success-bg': 'color-mix(in oklab, light-dark(var(--color-green-600), var(--color-green-400)) 10%, var(--background))',
          ...
          '--error-bg': 'color-mix(in oklab, light-dark(var(--color-red-600), var(--color-red-400)) 10%, var(--background))',
          '--error-text': 'light-dark(var(--color-red-600), var(--color-red-400))',
          '--error-border': 'light-dark(var(--color-red-600), var(--color-red-400))',
          '--warning-bg': 'color-mix(in oklab, light-dark(var(--color-amber-600), var(--color-amber-400)) 10%, var(--background))',
          ...
          '--info-bg': 'color-mix(in oklab, light-dark(var(--color-blue-600), var(--color-blue-400)) 10%, var(--background))',
